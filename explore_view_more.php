...
?>
            ...
            <div data-type="BurgerMenu" class="landing-page-burger-menu">
            ...
            <div data-type="MobileMenu" class="landing-page-mobile-menu">
              ...
              <div class="landing-page-follow-container">
                <span class="landing-page-text08">Follow us on</span>
          ...
          <div class="landing-page-hero">
            <div class="landing-page-content-container">
              <h1 class="heading landing-page-text09">Book an tourism Experience</h1>
              <h2 class="subheading landing-page-subheading">
                Home For The Best Tourism Experience
              </h2>
          ...
          <div class="landing-page-cards-container">
            ...
            <!-- <div class="place-card-container">
              ...
              <div class="place-card-container1">
                <span class="place-card-text"><span>Thailand Everest</span></span>
                <span class="place-card-text1">
                  <span>
                    Mount Everest is Earth's highest mountain above sea level, located in the Mahalangur. The China–Nepal border runs across its summit point. Its elevation of 8,848.86 m was most recently established in 2020 by the Chinese and Nepali authorities.
                  </span>
                </span>
                <div class="outline-button-container">
                  <button class="outline-button-button button">
            ...
            <div class="place-card-container">
              ...
              >
              <div class="place-card-container1">
                <span class="place-card-text"><span>Egypt Pyramids</span></span>
                <span class="place-card-text1">
                  <span>
            ...
            <div class="place-card-container">
              <img
                alt="image"
                src="images/effiel.jpg"
                class="place-card-image"
              >
              <div class="place-card-container1">
                <span class="place-card-text"><span>Paris Tower</span></span>
                <span class="place-card-text1">
                  <span>
            ...
            <div class="place-card-container">
              ...
              >
              <div class="place-card-container1">
                <span class="place-card-text"><span>Tanzania Kilimanjaro</span></span>
                <span class="place-card-text1">
                  <span>
            ...
            <div class="place-card-container">
              ...
              >
              <div class="place-card-container1">
                <span class="place-card-text"><span>Zambia Falls</span></span>
                <span class="place-card-text1">
                  <span>
                    Victoria Falls is a waterfall on the Zambezi River in southern Africa, which provides habitat for several unique species of plants and animals. It is located on the border between Zambia and Zimbabwe and is one of the world's largest waterfalls, with a width of 1,708 m. Boats a wonderful view and good time.
                  </span>
                </span>
                <div class="outline-button-container">
                  <button class="outline-button-button button">
        ...
        <div class="landing-page-footer">
          <div class="landing-page-menu">
            ...
            <div class="landing-page-follow-container1">
              <span class="landing-page-text16">Follow us on</span>
